...
public class NMSHandler_1_10_R1 implements NMSHandler {
	@Override
	public ItemStack addTag(ItemStack i, List<ItemTag> tags) {
	...
	@Override
	public Set<String> getTags(ItemStack i) {
	...
	@Override
	public void damageEntity(Player player, LivingEntity target, double value) {
		((CraftLivingEntity) target).getHandle().damageEntity(DamageSource.playerAttack((EntityHuman) ((CraftPlayer) player).getHandle()), (float) value);
	}

	@Override
	public void sendJson(Player player, String msg) {
